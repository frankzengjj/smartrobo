...
const Signin = ({onRouteChange}) => {
    return (
        <article className="br3 ba mv4 w-100 w-50-m w-25-l mw6 shadow-5 grow center">
            <main className="pa4 black-80">
                <div className="measure">
                    ...
                    <div className="mt3">
                        ...
                        <input className="pa2 input-reset ba bg-transparent hover-white w-100" type="text" name="user-name"  id="user-name"/>
                    </div>
                    <div className="mt3">
